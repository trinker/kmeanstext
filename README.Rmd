...
As with many topic clustering techniques, it is useful to get the to salient terms from the model.  The `get_terms` function uses the `centers` from the `kmeans` output.   Notice the absence of clusters 1 & 2.  This is a result of only a single document included in each of the clusters.  
